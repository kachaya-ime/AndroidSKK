...
public class Dictionary {
    ...
    /**
     * 指定された候補が、指定された送り仮名の制約を満たしているか検証します。
     *
     * @param okurigana 送り仮名（例: "い"）
     * @param s          検証対象の候補文字列（生データ）
     * @param entry      検索された辞書エントリ
     * @return 制約を満たしている（または制約がない）場合は true
     */
    ...
    /**
     * ユーザー辞書の全内容を、SKK 辞書形式（Lisp 互換）の文字列リストとして一括エクスポートします。
     *
     * @return 辞書全件の文字列リスト
     */
